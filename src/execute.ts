...
export function Spawn(command:string, args:string[] | null, env: { [key:string]: string | null }, cwd: string, stdout: any, stderr: any): Promise<boolean> {
